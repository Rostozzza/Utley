...
public class UnitScript : MonoBehaviour
{
	...
	public void SelectUnit()
	{
		...
		if (shouldWeShowAvailableAssignments) GameManager.Instance.ShowAvailableAssignments();
		else GameManager.Instance.HideAllAssignButtons();
	...
	public IEnumerator MoveInRoom(RoomScript.Resources roomType, List<Vector3> walkPoints, GameObject obj)
	{
		...
		switch (roomType)
		{
			...
			case RoomScript.Resources.Build:
				walkingCoroutine = StartCoroutine(BuildBehaviour(walkPoints[0], obj));
	...
	private IEnumerator BuildBehaviour(Vector3 workPoint, GameObject obj)
	{
		EventManager.onBearWorkStarted.Invoke(GetComponent<UnitMovement>().currentRoom);
