    ...
    private string RoomToText(RoomType room, KindOfText kind)
    {
        return kind switch
        {
            ...
            KindOfText.description => room switch
            {
                ...
                RoomType.Supply => "Снабжает комплексы энергией. Настраивает подачу энергии с помощью графов. Питает комплексы вокруг.",
                RoomType.Build => "Позволяет строить, ремонтировать и улучшать комплексы. Неразрушаемый. Улучшение ускоряет работу.",
                _ => "Неизвестная комната",
            },
